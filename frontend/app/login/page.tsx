    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold">Sign in to AutoGrade</h2>
          <p className="mt-2 text-gray-600">Use your Google account to continue</p>
        </div>
        <div>
          <button
            onClick={() => signIn('google', { callbackUrl: '/autograde' })}
